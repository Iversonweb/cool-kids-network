...
class CreatePages implements RegisterInterface
{
    ...
    protected $pages = [
        [
            ...
            'template' => [
                [ 
                    'core/paragraph', [ 'placeholder' => 'Welcome to the User Dashboard.' ],
                ],
                [ 
                    'core/shortcode', [ 'text' => '[ckn_user_dashboard]' ],
                ],
            ]
        ],
        [
            ...
            'template'      => [
                [
                    'core/paragraph', [ 'placeholder' => 'Welcome to the User Directory.' ],
                ],
                [ 
                    'core/shortcode', [ 'text' => '[ckn_user_directory]' ],
                ],
            ] 
        ],
    ];
